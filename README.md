...
### R$ 1000,00 + Domínio + Email + Hospedagem/mês + Design e Copywriter

## Desenvolvimento e Deploy

### Configuração de Hospedagem e Domínio (R$ 400,00):
- Deploy do sistema
...
### Requisitos de Desenvolvimento (R$ 600,00):
- Enviar para a pagina de checkout do querifire
- langin page de venda
- foco no SEO e UX/UI da página

## Hospedagem:
- [Hostgator](https://www.hostgator.com.br/servidor-vps) (R$ 82,39 até R$ 175,39)
- [Hostinger](https://www.hostinger.com.br/servidor-vps) (R$ 69,99 até R$ 149,99)
- [Vercel](https://vercel.com/pricing) (USD$ 0 até USD$ 20,00)  *recomendado neste caso*

## Email:
- [Hostgator](https://www.hostgator.com.br/servidor-vps) (R$ 8,90)
- [Hostinger](https://www.hostinger.com.br/servidor-vps) (R$ 9,99)

## Banco de dados: R$ 0,00 (não terá um grande volume de dados)
...
- Será cobrado 50% do valor total do projeto no início dele e 50% no final do projeto.
...
- Será cobrado 30% do valor total do projeto no início dele e o valor proporcional restante equivalente por etapa (exemplo: 30% de entrada e, se tiver 5 etapas, estas terão o valor equivalente a 14% do valor do projeto).
...
- Cada vez que a etapa for refeita:
    - Se for por um requisito que o cliente não levantou, será adicionada uma taxa de R$ 150,00 na etapa.
    - Se for por um requisito estipulado e não entregue, será dado um desconto no valor total do projeto de R$ 150,00.
...
## Design e Copywriter
- Para cada 10 mudanças simples, será adicionado R$ 20,00.
- Para cada 10 mudanças complexas, será adicionado R$ 50,00.
...
### Logo: (R$ 275,00)
- Criar o nome (R$ 125,00)
- Escolher a paleta de cores (R$ 75,00)
...
#### Ilustração de como funciona do banner principal (imagem: R$ 75,00, vídeo: R$ 150,00):
...
#### Ilustração para relatos (imagem: R$ 45,00, vídeo: R$ 85,00):
- Imagem de pessoas de verdade (não pode ser imagem de banco de imagens) com nome e sobrenome (não precisa ser completo)
- Texto dos relatos

#### Ilustração mostrando os serviços (imagem: R$ 70,00, vídeo: R$ 100,00):
...
#### Banner (imagem: R$ 75,00, vídeo: R$ 150,00):
- Referencias para o Banner

#### Ilustração mostrando compatibilidade (imagem: R$ 30,00, vídeo: R$ 50,00):
- Mostrar se funciona no Google ADS e afins

#### Ilustração mostrando o histórico de crescimento (imagem: R$ 50,00, vídeo: R$ 80,00): 
- Mostrar crescimento


### Vídeo ou animação mostrando como usar na prática o sistema
- Vídeo: R$ 150,00
- Vídeo + animação ilustrativa: R$ 180,00
- Animação com áudio original (feito por você com seu microfone) de até um minuto e meio: R$ 350,00
- Animação com dublagem de até um minuto e meio: R$ 550,00

### Vídeo editado com ilustrações(como prints) (imagem: R$ 70,00, vídeo: R$ 90,00):
